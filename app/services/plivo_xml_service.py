...
class PlivoXMLService:
    ...
    def generate_answer_xml(
        message: str = "Hello from PipeCat!",
        record: bool = True,
    ...
    @staticmethod
    def generate_conference_xml(
        room_name: str, participants: List[str], message: str = "Joining conference"
    ) -> str:
        ...
        response.add(plivoxml.ConferenceElement(room_name, **conference_params))
